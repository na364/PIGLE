/*
* File: frmBuilder_sfun_setclist.c
*
*
...
*  ------------------------------------------------------------------------- 
*
* Created: Sun Mar 31 16:46:49 2019
*/

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME frmBuilder_sfun_setclist
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Input Port  1 */
#define IN_PORT_1_NAME        calc_clist
...
#define NPARAMS               2
/* Parameter 0 */
#define PARAMETER_0_NAME      celldim
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter 1 */
#define PARAMETER_1_NAME      out_cutoff_r
...
#define SOURCEFILES           "__SFB__setclist.c"
#define PANELINDEX            8
...
const int32_T *calc_clist = (int32_T *) ssGetInputPortRealSignal(S, 1);
int32_T *clisti = (int32_T *) ssGetOutputPortRealSignal(S, 0);
int32_T *clist = (int32_T *) ssGetOutputPortRealSignal(S, 1);
const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
const real_T *celldim = (const real_T *) mxGetData(PARAM_DEF0(S));
const real_T *out_cutoff_r = (const real_T *) mxGetData(PARAM_DEF1(S));

frmBuilder_sfun_setclist_Outputs_wrapper(pos, calc_clist, clisti, clist, celldim, p_width0, out_cutoff_r, p_width1);
}
